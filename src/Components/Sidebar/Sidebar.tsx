...
const Sidebar = () => {
  return (
    <div>
      <aside className='flex h-screen w-72 flex-col overflow-y-hidden bg-slate-800 duration-300 ease-linear lg:static lg:translate-x-0'>
        ...
        <div className='no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear'>
          <nav className='mt-5 px-4 py-4 lg:mt-9 lg:px-6' x-data="{selected: $persist('Dashboard')}">
            <div>
